...
playerRouter
  ...
  .post("/statistic/learning_points/:operation/:learningPoints",
    async (req, res) => {
      const player_id = "865055da-1b49-11ee-af61-581122ba8110";
  ...
  .post("/statistic/add_attributes/:attribute/:learningPoints",
    async (req, res) => {
      const player_id = "865055da-1b49-11ee-af61-581122ba8110";
  ...
  .post("/buy", async (req, res) => {
    ...
    const results= await PlayerRecords.buyProduct(
      buyerId,
      sellerId,
      Number(productPrice),
      itemId,
